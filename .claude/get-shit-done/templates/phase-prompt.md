...
<!-- For checkpoint task examples and patterns, see @D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/get-shit-done/references/checkpoints.md -->
...
See `D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
