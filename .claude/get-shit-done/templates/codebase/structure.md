...
- Usage: Reference from command with `@D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
