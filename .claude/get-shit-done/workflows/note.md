...
- **Global scope**: `D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/notes/`)
...
2. Glob `D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/notes/` — works in any directory
