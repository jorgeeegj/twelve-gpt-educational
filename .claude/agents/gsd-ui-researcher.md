...
Use template from `D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
