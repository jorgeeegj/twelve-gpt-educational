...
Reference full template: `D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Twelve_Context_Eng/twelve-gpt-educational/.claude/get-shit-done/templates/state.md`.
